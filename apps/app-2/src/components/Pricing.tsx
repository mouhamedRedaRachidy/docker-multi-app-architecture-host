          ...
          {pricingTiers.map(
            ({
              ...
              <div
                key={title}
                className={twMerge(
                  "p-10 border rounded-3xl shadow-[0_7px_20px_rgba(0,0,0,0.12)] max-w-sm w-full",
              ...
              >
                ...
                <button
                  className={twMerge(
                    "bg-white text-black px-4 py-2 rounded-lg font-medium inline-flex align-items justify-center tracking-tight gap-1 mt-[30px] w-full",
